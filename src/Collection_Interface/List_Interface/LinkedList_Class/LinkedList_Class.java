package Collection_Interface.List_Interface.LinkedList_Class;
...
public class LinkedList_Class {
    public static void main(String[] args) {
        ...
        /**
         * Declaration of an LinkedList
         */
        List<Integer> list_1 = new LinkedList<>();

        /**
         * ---------------------Available Methods in LinkedList----------------------
         *
         * 1. add()                  --> To add elements in the LinkedList.
         * 2. addAll()               --> To add all the elements of list_1 into list_2.
         * 3. add(index_no,value)    --> To add a value in a specific index number.
         * 4. get(index_no)          --> To get an element by index number from the LinkedList.
